...
// كده فانكشن الابديت ليها طريقتين كتابة انا كل اللي لعمله هي هي نفي فانكشن الإضافة ولكن الفرق ان انا هنا هعدل مش هضيغ

//x[1,2,3]
//x[2] = 50
//كده انا عدلت علي الارراي اهو هنشتغل بنفس الطريقة برضو وهباضي الانديكس اللي مسكته وهعدل عليه بقي هاخد الحاجات الجديدة من الانبوت الجديد
//وبعدين اروح احط الحاجات في اللوكال ستوريج وبعدين اعرضها بس كده

let clearBtn = document.getElementById("clearBtn");

clearBtn.onclick = function () {
    proContainer = [];  // Clear the array
    localStorage.removeItem("products");  // Remove from localStorage
    disPro();  // Update the UI to reflect the changes
}
